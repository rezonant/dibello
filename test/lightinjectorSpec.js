...
describe('lightinjector', function () {
    ...
    it('provides parameters in any order', function (done) {
        ...
        light_injector_1.inject(map, this, function (a, b) {
            expect(a).toBe(123);
            expect(b).toBe(321);
        });
        light_injector_1.inject(map, this, function (b, a) {
            expect(a).toBe(123);
            expect(b).toBe(321);
            done();
        });
    ...
    it('calls $populate$ before injection', function (done) {
        ...
        light_injector_1.inject(map, this, function () {
            if (!injectionReady)
    ...
    it('calls $any$ when no service is available', function (done) {
        ...
        light_injector_1.inject(map, this, function (a, b123) {
            expect(a).toBe(123);
